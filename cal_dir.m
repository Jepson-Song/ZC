...
%         end
    ...
    if mov == cfg.static % 静止
        str = "静止";
        pos3 = cfg.O;
    elseif mov == cfg.surge % 前后移动
        str = "前后移动";
        pos3 = (pos1+pos2)/2 - cfg.ear2neck;
    elseif mov == cfg.sway % 左右移动
        str = "左右移动";
        pos3 = (pos1+pos2)/2 - cfg.ear2neck;
    elseif mov == cfg.heave % 上下移动
        str = "上下移动";
        pos3 = (pos1+pos2)/2 - cfg.ear2neck;
    elseif mov == cfg.roll % 左右倾斜
        str = "左右倾斜";
        pos3 = cfg.O;
    elseif mov ==  cfg.pitch % 前后俯仰
        str = "前后俯仰";
        pos3 = cfg.O;
    elseif mov == cfg.yaw % 左右旋转
        str = "左右旋转";
        pos3 = cfg.O;
    elseif mov == cfg.translation % 移动
        str = "移动";
        pos3 = (pos1+pos2)/2 - cfg.ear2neck;
    elseif mov == cfg.rotation % 转动
        str = "转动";
        pos3 = cfg.O;
    elseif mov == cfg.pitch_surge % 俯仰或前后移动
        str = "俯仰或前后移动";
        pos3 = cfg.O;
    else
        str = "未定义动作";
